...
class MachineModelTests(TestCase):
    ...
    def test_acheter_ressources(self):
        ...
        quantite_ressource1 = QuantiteRessource.objects.create(
            ressource=ressource1, quantite=5
        )
        quantite_ressource2 = QuantiteRessource.objects.create(
            ressource=ressource2, quantite=3
        )
        ...
        ressources_manquantes = usine.Acheter_Ressources(
            produit=produit, nombre_crayon=nombre_crayon
        )
